...
func (_m *DbClient) PutItem(ctx context.Context, params *dynamodb.PutItemInput, optFns ...func(*dynamodb.Options)) (*dynamodb.PutItemOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// DbClient_PutItem_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PutItem'
type DbClient_PutItem_Call struct {
	*mock.Call
}
...
//   - optFns ...func(*dynamodb.Options)
func (_e *DbClient_Expecter) PutItem(ctx interface{}, params interface{}, optFns ...interface{}) *DbClient_PutItem_Call {
	return &DbClient_PutItem_Call{Call: _e.mock.On("PutItem",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *DbClient_PutItem_Call) Run(run func(ctx context.Context, params *dynamodb.PutItemInput, optFns ...func(*dynamodb.Options))) *DbClient_PutItem_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*dynamodb.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *DbClient_PutItem_Call) Return(_a0 *dynamodb.PutItemOutput, _a1 error) *DbClient_PutItem_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DbClient_PutItem_Call) RunAndReturn(run func(context.Context, *dynamodb.PutItemInput, ...func(*dynamodb.Options)) (*dynamodb.PutItemOutput, error)) *DbClient_PutItem_Call {
	_c.Call.Return(run)
	return _c
}
